...
const app = express()
app.use(cors({credentials: true,origin:"https://front-of-backend-cuenca-qz37g4ulj-franmats.vercel.app/",methods:["GET","POST","PUT","DELETE"],allowedHeaders: ['Content-Type', 'Authorization']}))
